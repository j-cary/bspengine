...
//TODO:
//Start building the vertex list every frame, then transition to building it from the proper model list
//Texture stuff...
//I have an unfounded suspicion that one of the texture coordinates needs to get negated or something...
